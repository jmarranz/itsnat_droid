        ...
        extends AttrDescReflecMethod<TclassDesc,TattrTarget,TattrContext>
{
    ...
    {
        int convValue = getInteger(attr,attrCtx.getXMLInflater()); // No hay un Resources.getLong(), en Android aunque el atributo contenedor sea long el dato se suele manejar como int
