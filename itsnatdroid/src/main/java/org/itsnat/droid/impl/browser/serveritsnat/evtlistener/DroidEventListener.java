...
public class DroidEventListener extends NormalEventListener
{
    ...
    public DroidEventListener(ItsNatDocPageItsNatImpl parent, View currentTarget, String type, CustomFunction customFunc, String id, boolean useCapture, int commMode, long timeout, int eventGroupCode)
    {
