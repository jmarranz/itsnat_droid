 ...
 */
public abstract class _DELETED_AttrDescDrawableReflecMethod<TdrawableOrElementDrawable> extends _DELETE_AttrDescDrawable<TdrawableOrElementDrawable>
{
    protected MethodContainer method;

    @SuppressWarnings("unchecked")
    public _DELETED_AttrDescDrawableReflecMethod(ClassDescDrawable parent, String name, String methodName, Class classParam)
    {
        super(parent,name);
    ...
    public _DELETED_AttrDescDrawableReflecMethod(ClassDescDrawable parent, String name, Class classParam)
    {
