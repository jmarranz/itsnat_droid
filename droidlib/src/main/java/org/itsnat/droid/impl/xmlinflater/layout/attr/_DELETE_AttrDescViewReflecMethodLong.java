 ...
 */
public class _DELETE_AttrDescViewReflecMethodLong extends _DELETED_AttrDescViewReflecMethod
{
    protected Long defaultValue;

    public _DELETE_AttrDescViewReflecMethodLong(ClassDescViewBased parent, String name, String methodName, Long defaultValue)
    {
        super(parent,name,methodName,getClassParam());
        this.defaultValue = defaultValue;
    }

    public _DELETE_AttrDescViewReflecMethodLong(ClassDescViewBased parent, String name, Long defaultValue)
    {
