 ...
 */
public abstract class _DELETE_AttrDescViewReflecMethodDimensionInt extends _DELETED_AttrDescViewReflecMethod
{
    protected Float defaultValue;

    public _DELETE_AttrDescViewReflecMethodDimensionInt(ClassDescViewBased parent, String name, String methodName, Float defaultValue)
    {
        super(parent,name,methodName,getClassParam());
        this.defaultValue = defaultValue;
    }

    public _DELETE_AttrDescViewReflecMethodDimensionInt(ClassDescViewBased parent, String name, Float defaultValue)
    {
