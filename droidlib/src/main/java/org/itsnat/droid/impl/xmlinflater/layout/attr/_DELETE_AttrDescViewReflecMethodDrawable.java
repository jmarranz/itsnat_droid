 ...
 */
public class _DELETE_AttrDescViewReflecMethodDrawable extends _DELETED_AttrDescViewReflecMethod
{
    protected String defaultValue;

    public _DELETE_AttrDescViewReflecMethodDrawable(ClassDescViewBased parent, String name, String methodName, String defaultValue)
    {
        super(parent,name,methodName,getClassParam());
        this.defaultValue = defaultValue;
    }

    public _DELETE_AttrDescViewReflecMethodDrawable(ClassDescViewBased parent, String name, String defaultValue)
    {
