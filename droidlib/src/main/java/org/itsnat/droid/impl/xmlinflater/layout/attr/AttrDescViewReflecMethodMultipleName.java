...
{
    public AttrDescViewReflecMethodMultipleName(ClassDescViewBased parent, String name, String methodName, MapSmart<String, Integer> valueMap, String defaultName)
    {
        super(parent,name,methodName,getClassParam(),valueMap,defaultName);
    }

    public AttrDescViewReflecMethodMultipleName(ClassDescViewBased parent, String name, MapSmart<String, Integer> valueMap, String defaultName)
    {
